 ...
 * {@link com.eitan.petsi.SearchFragment.OnFragmentSearchInteractionListener} interface
...
//      Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter<CharSequence> animalAdapter =
                ArrayAdapter.createFromResource(getActivity().getBaseContext(), R.array.types_array,android.R.layout.simple_spinner_dropdown_item);
...
//      Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter<CharSequence> genderAdapter =
                ArrayAdapter.createFromResource(getActivity().getBaseContext(), R.array.gender_array,android.R.layout.simple_spinner_dropdown_item);
...
//      Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter<CharSequence> sizeAdapter =
                ArrayAdapter.createFromResource(getActivity().getBaseContext(), R.array.sizes_array,android.R.layout.simple_spinner_dropdown_item);
